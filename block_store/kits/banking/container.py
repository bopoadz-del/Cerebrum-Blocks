"""Banking Operations Suite — domain container stub.

Subclasses ``DomainContainer`` (``app/containers/base.py``). When this kit is
published, ``container.py`` is copied to ``app/containers/banking.py`` per
