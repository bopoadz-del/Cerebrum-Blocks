"""Manufacturing domain knowledge — rules and custom user rules injection."""
...
CRITICAL_RULES: Dict[str, str] = {
    "critical": "Product quality and traceability must be maintained throughout production.",
}
...
class ManufacturingKnowledge:
    """Single import point for manufacturing domain knowledge."""
