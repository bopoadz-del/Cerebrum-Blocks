...
deterministic pass/fail per stage, and refuse to report a number that failed
validation.
...
Input shape::

    {
        ...
        "context": {
            ...
            "currency": "USD",                 # optional; swaps the cost band
...
class ValidationPipelineBlock(UniversalBlock):
    ...
    async def process(self, input_data: Any, params: Dict = None) -> Dict:
        ...
        # Params can promote slack_factor / strict / currency / metric / material_type without
