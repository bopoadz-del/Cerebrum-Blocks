#!/usr/bin/env python3
"""
Auto-generated adapter for Cerebrum block: pdf
Wraps app.blocks.pdf into a synchronous run() function.
"""
...
def run(**kwargs):
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or "pdf block failed")
