...
Wraps app.blocks.capture.CaptureBlock.execute() into a synchronous run() function.
"""
...
def run(**kwargs):
    ...
    """
    block_cls = BLOCK_REGISTRY["capture"]
    instance = block_cls()
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or f"capture block failed")
