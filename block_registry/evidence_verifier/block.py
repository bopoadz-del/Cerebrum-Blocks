#!/usr/bin/env python3
"""
Auto-generated adapter for Cerebrum block: evidence_verifier
Wraps app.blocks.evidence_verifier into a synchronous run() function.
"""
...
def run(**kwargs):
    ...
    """
    instance = EvidenceVerifierBlock()
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or "evidence_verifier block failed")
