...
Wraps app.blocks.recommendation_template.RecommendationTemplateBlock.execute() into a synchronous run() function.
"""
...
def run(**kwargs):
    ...
    """
    block_cls = BLOCK_REGISTRY["recommendation_template"]
    instance = block_cls()
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or f"recommendation_template block failed")
