...
Wraps app.blocks.analytics.AnalyticsBlock.execute() into a synchronous run() function.
"""
...
def run(**kwargs):
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or f"analytics block failed")
