...
Wraps app.blocks.database.DatabaseBlock.execute() into a synchronous run() function.
"""
...
def run(**kwargs):
    ...
    """
    block_cls = BLOCK_REGISTRY["database"]
    instance = block_cls()
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or f"database block failed")
