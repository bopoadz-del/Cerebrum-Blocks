...
Wraps app.blocks.event_bus.EventBusBlock.execute() into a synchronous run() function.
"""
...
def run(**kwargs):
    ...
    """
    block_cls = BLOCK_REGISTRY["event_bus"]
    instance = block_cls()
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or f"event_bus block failed")
