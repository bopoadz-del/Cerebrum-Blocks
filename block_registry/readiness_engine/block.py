#!/usr/bin/env python3
"""
Auto-generated adapter for Cerebrum block: readiness_engine
Wraps app.blocks.readiness_engine into a synchronous run() function.
"""
...
def run(**kwargs):
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or "readiness_engine block failed")
