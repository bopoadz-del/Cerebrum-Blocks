#!/usr/bin/env python3
"""
Auto-generated adapter for Cerebrum block: aviation_cx_kit
Wraps app.blocks.aviation_cx_kit into a synchronous run() function.
"""
...
def run(**kwargs):
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or "aviation_cx_kit block failed")
