...
Wraps app.blocks.llm_enhancer.LLMEnhancerBlock.execute() into a synchronous run() function.
"""
...
def run(**kwargs):
    ...
    """
    block_cls = BLOCK_REGISTRY["llm_enhancer"]
    instance = block_cls()
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or f"llm_enhancer block failed")
