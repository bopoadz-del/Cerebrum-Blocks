...
Wraps app.blocks.bim_extractor into a synchronous run() function.
"""
...
def run(**kwargs):
    ...
    """
    block_cls = get_block("bim_extractor")
    instance = block_cls()
    ...
    if envelope.get("status") == "error":
        ...
        raise RuntimeError(message or "bim_extractor block failed")
