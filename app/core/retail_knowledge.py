"""Retail domain knowledge — rules and custom user rules injection."""
...
CRITICAL_RULES: Dict[str, str] = {
    "critical": "MSRP and MAP pricing must be clearly stated.",
}
...
class RetailKnowledge:
    """Single import point for retail domain knowledge."""
