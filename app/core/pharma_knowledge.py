"""Pharma domain knowledge — rules and custom user rules injection."""
...
CRITICAL_RULES: Dict[str, str] = {
    "critical": "Batch records must be complete and deviations documented.",
}
...
class PharmaKnowledge:
    """Single import point for pharma domain knowledge."""
