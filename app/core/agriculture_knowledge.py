"""Agriculture domain knowledge — rules and custom user rules injection."""
...
CRITICAL_RULES: Dict[str, str] = {
    "critical": "Pesticide applications must follow label instructions.",
}
...
class AgricultureKnowledge:
    """Single import point for agriculture domain knowledge."""
