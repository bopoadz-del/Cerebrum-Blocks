...
(civil/infrastructure) and POMI (buildings).
...
_RULES = [
    ...
    ("m2", [r"fabric reinforc", r"mesh reinforc", r"reinforc\w* mesh", r"welded fabric", r"\brc\b"]),
...
def reconcile_unit(
    parsed_unit: str, description: str
    ...
    if not p or p.lower() == "nan":
        return (
            (inferred, "inferred", False, None)
            if inferred
            else ("", "parsed", False, None)
        )
