"""oil and gas construction reasoning kit — store-facing block.

Identity only. Every rule this block enforces is DECLARED in
``app/blocks/og_construction/manifest.yaml`` (vocabulary) and ``invariants.yaml``
...
class OgConstructionKitBlock(ReasoningKitBlock):
    ...
    tags = ['oil_gas', 'construction', 'brownfield']
