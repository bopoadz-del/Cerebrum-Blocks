"""heritage building restoration reasoning kit — store-facing block.

Identity only. Every rule this block enforces is DECLARED in
``app/blocks/heritage/manifest.yaml`` (vocabulary) and ``invariants.yaml``
...
class HeritageKitBlock(ReasoningKitBlock):
    ...
    tags = ['heritage', 'conservation', 'restoration']
