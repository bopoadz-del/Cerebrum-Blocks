"""Scope Extractor block — thin wrapper over the document engine.

Focuses document-engine output into a schedule-scope shape: requirements,
constraints, schedule targets, equipment lead times, and milestones.
"""
