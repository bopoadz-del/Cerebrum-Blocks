"""cosmetic and aesthetic clinics reasoning kit — store-facing block.

Identity only. Every rule this block enforces is DECLARED in
``app/blocks/aesthetic/manifest.yaml`` (vocabulary) and ``invariants.yaml``
