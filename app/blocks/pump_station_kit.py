"""water pump station operations reasoning kit — store-facing block.

Identity only. Every rule this block enforces is DECLARED in
``app/blocks/pump_station/manifest.yaml`` (vocabulary) and ``invariants.yaml``
